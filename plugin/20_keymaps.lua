...
local explore_zoxide = function()
  MiniPick.start({
    source = {
      items = vim.fn.systemlist('zoxide query -l'),
      name = "Zoxide",
...
nmap_leader("ez", explore_zoxide,                           'Zoxide')
...
nmap_leader('gz', '<Cmd>lua Snacks.lazygit()<CR>', 'LazyGit')
